...
public class GUI {
	...
	public void buildwindows() {
		...
		panel.add(filebtn);
		filebtn.addActionListener(new FileButtonActionListener(GUI.this, dlg));
		...
		decoder.addActionListener(new ComboBoxActionListener(GUI.this));
		training.addActionListener(new ComboBoxActionListener(GUI.this));
		method.addActionListener(new ComboBoxActionListener(GUI.this));
		...
		runbtn.addActionListener(new RunButtonActionListener(GUI.this));
		panel.add(runbtn);
