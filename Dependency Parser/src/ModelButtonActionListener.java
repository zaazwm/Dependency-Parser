...
public class ModelButtonActionListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(gui instanceof GUI2 || gui instanceof GUIThesis)
			gui.getMainwindow().setTitle("Dependency Parser - Data: "+(gui.getFilepath()==null?"No Data File":gui.getFilepath())+" Model: "+(gui.getModelPath()==null?"No Model Folder":gui.getModelPath()));
